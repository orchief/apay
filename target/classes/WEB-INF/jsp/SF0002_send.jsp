    ...
    %>
     ...
     <TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0> 
         <TR VALIGN=TOP ALIGN=LEFT> 
             ...
             <TD COLSPAN=2><b><FONT COLOR="#FF0000" FACE= "宋体 "  SIZE="3"><%=beginDate%>到<%=endDate%>时间段内订单信息如下：</FONT></b></TD> 
             </TR> 
				  ...
				  <TR>
					...
					<%
						for (int i = 0; i < icoll.size(); i++) {
							...
							String date = (String) kcoll.getDataValue("date");
					...
					<TD align ="right" BORDER=1 CELLSPACING=1 CELLPADDING=1><FONT COLOR="#003399 " FACE="宋体 "><%=date%></FONT></TD>	    
