...
function check()
{
    ...
    if(document.forms[0].refundNo.value=="")
	{
	    alert("请输入退款订单号");
		document.forms[0].refundNo.focus();
...
<BODY BACKGROUND="./images/logo2.gif" BGCOLOR="#FFFFFF" LINK="#0000FF" VLINK="#800080" TEXT="#000000" TOPMARGIN=0 LEFTMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0>
    <TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0 WIDTH=555>
        ...
        <TR VALIGN=TOP ALIGN=LEFT>
            <TD></TD>
            <TD WIDTH=293>
      <P><FONT COLOR="#003399" FACE="宋体">请输入查询退款订单信息：</FONT>
    </TD>
            <TD></TD>
        </TR>
        <TR VALIGN=TOP ALIGN=LEFT>
        ...
        <TR VALIGN=TOP ALIGN=LEFT>
            ...
            <TD WIDTH=525 COLSPAN=2>
                <form  NAME="LayoutRegion1FORM" ACTION="SF0009_send.jsp" METHOD=POST onSubmit="return check()">
                            ...
                            <TD WIDTH=518>
                                <TABLE ID="Table1" BORDER=0 CELLSPACING=3 CELLPADDING=0 WIDTH=518>
                                   <TR>
                                     ...
                                     <TR>
                                        <TD WIDTH=80><P><FONT COLOR="#003399" FACE="宋体">退款单号：</FONT></TD>
                                        <TD WIDTH=342><P><INPUT ID="refundNo" TYPE=TEXT NAME="refundNo" VALUE="" SIZE=30 MAXLENGTH=26>&nbsp;
                                        </TD>
                                    </TR>
                                 
                                    <TR>
                                        <TD COLSPAN=2><P><INPUT TYPE=SUBMIT NAME="FormsButton1" VALUE="查询退款订单" ID="FormsButton2">&nbsp;</TD>
                                    </TR>
                                    <TR>
