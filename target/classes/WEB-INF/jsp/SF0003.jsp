...
<BODY BACKGROUND="./images/logo2.gif" BGCOLOR="#FFFFFF" LINK="#0000FF" VLINK="#800080" TEXT="#000000" TOPMARGIN=0 LEFTMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0>
    <TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0 WIDTH=555>
        ...
        <TR VALIGN=TOP ALIGN=LEFT>
            <TD></TD>
            <TD WIDTH=293>
      <P><FONT COLOR="#003399" FACE="宋体">请输入对账单信息：</FONT>
    </TD>
            <TD></TD>
        </TR>
        <TR VALIGN=TOP ALIGN=LEFT>
        ...
        <TR VALIGN=TOP ALIGN=LEFT>
            ...
            <TD WIDTH=525 COLSPAN=2>
                <form  NAME="LayoutRegion1FORM" ACTION="SF0003_send.jsp" METHOD=POST onSubmit="return check()">
                            ...
                            <TD WIDTH=518>
                                <TABLE ID="Table1" BORDER=0 CELLSPACING=3 CELLPADDING=0 WIDTH=800>
                                   <TR>
                                        ...
                                        <TD WIDTH=700><P><INPUT ID="masterId" TYPE=TEXT NAME="masterId"  SIZE=30 MAXLENGTH=10 value="2000311146">&nbsp;
                                        </TD>
                                    </TR>
                                     <TR>
                                        <TD><P><FONT COLOR="#003399" FACE="宋体">对账日期：</FONT></TD>
                                        <TD><P><INPUT ID="date" TYPE=TEXT NAME="date" VALUE="" SIZE=30 MAXLENGTH=8>&nbsp;(格式：YYYYMMDD)
                                        </TD>
                                    </TR>
                                    <TR>
